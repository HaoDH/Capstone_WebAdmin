<%-- 
    Document   : lockscreen
    Created on : Aug 8, 2018, 4:04:06 PM
    Author     : haodang
--%>
        ...
        <div class="page-container">
                ...
                <div class="page-inner login-page">
                    <div id="main-wrapper" class="container-fluid">
                        <div class="row">
                            <div class="col-sm-6 col-md-3 login-box lock-screen">
                                <p>
                                    <img src="http://via.placeholder.com/50x50" alt=""><span>John Doe</span>
                                </p>
                                <div class="form-group">
                                    <div style="margin-bottom:15px;" class="input-group">
                                        <input type="password" class="form-control" placeholder="Password">
                                        <span class="input-group-btn">
                                            <a class="btn btn-primary" href="index.jsp"><i class="fa fa-angle-right"></i></a>
                                        </span>
                                    </div>
                                </div>
                            </div>
