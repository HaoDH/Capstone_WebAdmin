$(document).ready(function(){
    ...
    var n=100,t=!0,s=!1,i=!1,l=!1,a=$("body"),o=($(".page-header"),$(".page-sidebar"),$(".page-content"),function(){
    ...
    ,u=function(){
        var e=$(".page-sidebar li:not(.open) .sub-menu"),s=$(".page-sidebar li.active-page > a");
        e.hide(),t===!1&&$(".sub-menu li").each(function(e){
            $(this).addClass("animation")
        }
        ),$(".accordion-menu").on("click","a",function(){
            var e=$(this).next(".sub-menu"),s=$(this).parent("li"),i=$(".accordion-menu > li.open"),l=function(){
