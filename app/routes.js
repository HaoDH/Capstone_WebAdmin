...
module.exports = function (app, passport) {
    ...
    app.get('/weekly-report', isLoggedIn, function (req, res) {
        res.render('../weekly-report.ejs', {
            user: req.user 
        });
    });
    ...
    app.get('/table-report', isLoggedIn, function (req, res) {
        res.render('../table-report.ejs', {
            user: req.user 
        });
    });
